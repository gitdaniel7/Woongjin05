...
const footerLinks = [
  {
    label: "개인정보처리방침",
    url: "https://www.mcdonalds.co.kr/kor/etc/private.do",
  },
  ...
  {
    label: "인재채용",
    url: "https://www.mcdonalds.co.kr/kor/story/people/recruit.do",
  },
];
...
const socialLinks = [
  {
    label: "페이스북",
    url: "https://www.facebook.com/McDonaldsKorea",
    bgPos: "0 0",
  },
  {
    label: "인스타그램",
    url: "https://www.instagram.com/mcdonalds_kr/",
    bgPos: "0 -40px",
  },
  {
    label: "유튜브",
    url: "https://www.youtube.com/user/McDonaldsKor",
    bgPos: "0 -80px",
  },
  {
    label: "카카오스토리",
    url: "https://story.kakao.com/ch/mcdonalds/feed",
    bgPos: "0 -120px",
  },
  {
    label: "한국디지털접근성진흥원",
    url: "http://kdaa.or.kr/CertificationSite/WA/2200/Detail",
    iconUrl:
      "https://www.mcdonalds.co.kr/kor/images/common/web_accessibility.png",
  },
];

const Footer = forwardRef((props, ref) => {
  return (
    <footer className="bg-[#292929] text-white py-8" ref={ref}>
      <div className="w-[1168px] mx-auto flex justify-between">
          ...
          {footerLinks.map(({ label, url }) => (
            <a
              ...
              className={`footer-link hover:underline ${
                label === "개인정보처리방침" ? "text-yellow-400" : ""
              }`}
            >
              {label}
            </a>
        ...
        <div className="flex flex-col items-end space-y-6 min-w-[280px]">
              ...
              <a
                ...
                style={{
                  backgroundImage: iconUrl
                    ? `url(${iconUrl})`
                    : `url('https://www.mcdonalds.co.kr/kor/images/common/ico_sns.png')`,
          ...
          <div className=" flex w-full max-w-[340px]  text-xs">
            <div>
              <img
                className="w-[60px] h-[60px] bg-white rounded-[4px]"
                src="https://www.mcdonalds.co.kr/kor/images/common/web_isms.png"
                alt="정보보호관리체계"
              />
            </div>
            <div>
